...
namespace Alura.Estacionamento.Modelos
{
    public class Patio
    {
        ...
        {
            var veiculoRetorno = (from veiculo in this.Veiculos
        ...
        {
            var veiculoNoEstacionamento = (from veiculo in this.Veiculos
                                           where veiculo.Placa == veiculoAlterado.Placa
                                           select veiculo).SingleOrDefault();
            veiculoNoEstacionamento.AlterarDados(veiculoAlterado);
            return veiculoNoEstacionamento;
        }
